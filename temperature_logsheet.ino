...
const char* ssid = "DESKTOP-14NNSIF 7185"; //--> Your wifi name or SSID.
const char* password = "123andoh"; //--> Your wifi password.
//----------------------------------------
...
String GAS_ID = "AKfycbwADEtpZ_QTStPuh-mDYDuUTjEgfVL2zfElTgzOme1eeBXpLkLav0W6ay-FNB_xlfX1_w"; //--> spreadsheet script ID
